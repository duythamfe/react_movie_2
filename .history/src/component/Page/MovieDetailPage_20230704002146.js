    ...
    if (video)
        return (
            <div className='p-3 w-full aspect-video rounded-lg bg-black bg-opacity-30 mb-8'>
                ...
                <iframe className='rounded-sm w-full h-full object-fill' src={`https://www.youtube.com/embed/${videoKey}`} frameborder="0" allowfullscreen></iframe>
            </div>
        )
}


function MovieSimular() {

    return (
        <div className='p-3 w-full rounded-lg bg-black bg-opacity-30 mb-8'>
            <h3 className="text-[#3CE2E8] text-[16px] font-bold mb-2">Simular Movies</h3>
