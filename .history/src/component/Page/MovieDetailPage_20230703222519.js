                                ...
                                <div className='detail-overview'>
                                    ...
                                    <div className='flex gap-2 flex-wrap'>
                                        {producComp.length > 0 ? producComp.map((item) => (
                                            <div key={item.id} className='w-[calc(20%_-_8px)] aspect-square rounded-sm overflow-hidden bg-white p-2'>
        ...
        <div>
            ...
            <div className="flex gap-3 flex-wrap">
                {cast.slice(0, 5).map((item) => {
                    ...
                    return (
                        <div className='flex flex-col gap-3 content-center' key={item.id}>
