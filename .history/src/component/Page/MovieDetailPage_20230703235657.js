...
function VideoPlay() {
    ...
    return (
        <div className='p-3 rounded-lg bg-black bg-opacity-30 mb-8'>
            <iframe width="100%" height="315" src="https://www.youtube.com/embed/ACsfcWYbzbk" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
        </div>
    )
}
