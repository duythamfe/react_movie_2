...
function VideoPlay() {
    ...
    const videoList = data ? data.results[0] : [];
    console.log(videoList);

    return (
        <div className='p-3 rounded-lg bg-black bg-opacity-30 mb-8'>
            <iframe className='rounded-sm' width="100%" height="500" src="https://www.youtube.com/embed/ACsfcWYbzbk" frameborder="0" allowfullscreen></iframe>
        </div>
    )
}
