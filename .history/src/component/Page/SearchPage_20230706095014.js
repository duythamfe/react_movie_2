...
const SearchPage = () => {
    ...
    const { data, isLoading } = useSWR(`https://api.themoviedb.org/3/search/movie?api_key=${apiKey}&query=${query}`, fetcher, { initialData: { results: [], page: 1, total_pages: 1 } });
    const movies = data ? data.results : [];
    const { page, total_pages } = data ? data : null;
    console.log(page);
                ...
                {isLoading ? (
                    ...
                    <div className='detail-content'>
                        ...
                        <div className="flex gap-4 justify-center items-center my-8">
                            ...
                            <span className='text-white rounded-md border border-white px-2 py-1'>1</span>
