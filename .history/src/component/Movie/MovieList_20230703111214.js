        ...
        <div className='item-contain'>
            ...
            <div className='item-list relative'>
                ...
                <div className='slide-nav'>
                    <span className='slide-nav-btn cursor-pointer text-white' id='swiper-prev' onClick={handlePrevSlide}><FontAwesomeIcon icon={faArrowLeft} /></span>
                    <span className='slide-nav-btn cursor-pointer text-white' id='swiper-next' onClick={handleNextSlide}><FontAwesomeIcon icon={faArrowRight} /></span>
                </div>
            </div>
        </div>
    );
