        ...
        <div className='item-contain'>
            ...
            <div className='item-list relative'>
                ...
                <div className='slide-nav'>
                    <span onClick={() => swiper.slidePrev()} className='slide-nav-btn cursor-pointer text-white' id='swiper-prev'><FontAwesomeIcon icon={faArrowLeft} /></span>
                    <span onClick={() => swiper.slideNext() className='slide-nav-btn cursor-pointer text-white' id='swiper-next'><FontAwesomeIcon icon={faArrowRight} /></span>
                </div>
            </div>
        </div>
    );
