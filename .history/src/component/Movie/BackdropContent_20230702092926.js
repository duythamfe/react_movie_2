...
const BackdropContent = () => {
    ...
    useEffect(() => {
        fetch("https://api.themoviedb.org/3/genre/movie/list?api_key=04a3534c85b97d2bfd72d750a1764af1")
        ...
        <div className='backdrop-content'>
            ...
            <div className='backdrop-content-info'>
                ...
                <div className='backdrop-content-info_tags'>
                    {genreName.length > 0 ? genreName.map((genre, index) => (
                ...
                <div className='flex gap-3 items-center'>
                    <span className='backdrop-content-info_year'>{new Date(backdrop.release_date).getFullYear()}</span>
                    <span className='backdrop-content-info_point'><FontAwesomeIcon icon={faStar} /> {backdrop.vote_average}</span>
                </div>
