  ...
  return (
    <Fragment>
      <Routes>
        ...
        <Route path='/movie/:movie_id' element={<Header></Header><MovieDetail></MovieDetail>}></Route>
        <Route path='/search/:query' element={<Header></Header><SearchPage></SearchPage>}></Route>
      </Routes>
