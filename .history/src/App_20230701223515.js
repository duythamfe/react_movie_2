              ...
              <div className='backdrop-content-info'>
                <div className='backdrop-content-info_top'>
                  ...
                  <div className='backdrop-option'>
                    <button className='btn-lg blue'>Favorite <FontAwesomeIcon icon={faHeart} /></button>
                    <button className='btn-lg pink'>Watch Now <FontAwesomeIcon icon={faCirclePlay} /></button>
                  </div>
                </div>
              </div>
            </div>
